...
vectorstore = FAISS.load_local(MAIN_DIR / "titanic_data", embedding_model,allow_dangerous_deserialization=True)
...
agent = OpenAIFunctionsAgent(
    llm=ChatOpenAI(temperature=0, model="gpt-4o-mini"), prompt=prompt, tools=tools
)
